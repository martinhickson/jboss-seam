...
/**
 * Verifies JSF POST navigation for the hotel booking wizard (Book Hotel commandButton).
 */
@RunWith(Arquillian.class)
public class BookingJsfPostWildFly36IT {
    ...
    @Test
    @RunAsClient
    public void bookHotelJsfPostNavigatesToBookingForm() throws Exception {
