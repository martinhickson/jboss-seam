...
public class DelegatingFacesContext extends FacesContext
{
   ...
   public Lifecycle getLifecycle() {
      try {
         Method method = delegate.getClass().getMethod("getLifecycle");
         return (Lifecycle) method.invoke(delegate);
      } catch (Exception e) {
         throw new IllegalStateException("Could not access getLifecycle via reflection", e);
      }
   }
